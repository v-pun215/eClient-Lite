...
ASCII = r"""
          ____   _   _                  _       _       _   _          
   ___   / ___| | | (_)   ___   _ __   | |_    | |     (_) | |_    ___ 
  / _ \ | |     | | | |  / _ \ | '_ \  | __|   | |     | | | __|  / _ \
 |  __/ | |___  | | | | |  __/ | | | | | |_    | |___  | | | |_  |  __/
  \___|  \____| |_| |_|  \___| |_| |_|  \__|   |_____| |_|  \__|  \___|
                                                                       By v-pun215
...
def config_window():
    ...
    ConfigWindow.title("Settings")# sets window title
    ConfigWindow.iconbitmap("set.ico")
    ...
    Warning_Label = Label(
        ConfigWindow,
        text="Settings (For advanced users)",
...
def play():
    ...
    # NonPremium code
    if Email == "":
        warning_box("eClient Lite Error!", "Username cannot be empty!")
    else:
        if Config.Config["Premium"]:
...
def check_internet() -> bool:
    ...
    try:
        resp = requests.get(INTERNET_TEST_URL, timeout=10)
...
if __name__ == "__main__":
    ...
    MainWindow.title("eClient Lite")  # sets window title
    if SYSTEM == "Windows":
        # other systems dont use ico
        MainWindow.iconbitmap(constants.ui.LOGO_ICON)  # sets window icon
    ...
    PInfo2_Label = Label(
        MainWindow,
        text="Lightweight edition of eClient",
        bg=constants.ui.BG_COLOUR,
        fg="white",
        font = ("SF Pro Display", int(11.0),),
    )
    ...
    Password_Label = Label(
        MainWindow,
        text="Password (Leave empty for non-premium):",
        bg=constants.ui.BG_COLOUR,
        fg="white",
        font = ("SF Pro Display", int(12.0),),
    )
